...
const dynamicTranslates = {
	...
	fengliao(player) {
		if (Boolean(player.storage["fengliao"])) return `锁定技，转换技，你使用牌指定唯一目标后，阴：你令其摸一张牌；<span class="bluetext">阳：你对其造成一点火焰伤害。</span>`;
		return `锁定技，转换技，你使用牌指定唯一目标后，<span class="bluetext">阴：你令其摸一张牌</span>；阳：你对其造成一点火焰伤害。`;
	},
};
