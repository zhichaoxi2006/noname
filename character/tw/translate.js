const translates = {
	...
	twchenxun: "沉勋",
	twchenxun_info: "一轮游戏开始时，你可以视为对一名其他角色使用一张【决斗】。此牌结算结束后，若此牌对其造成过伤害，你摸两张牌且可以对一名本轮未以此法选择的其他角色发动〖沉勋〗；否则你失去X点体力（X为你本轮以此法使用【决斗】的次数）。",
	huan_caoang: "幻曹昂",
	huan_caoang_prefix: "幻",
	twchihui: "炽灰",
	twchihui_info: "其他角色的回合开始时，你可废除一个装备栏并选择一项:1.弃置其区域内的一张牌；2.將牌堆中的一张与此次废除的装备栏相同副类别的装备牌置入其装备区。若如此做，你失去1点体力，然后摸X张牌（X为你已损失的体力值）。",
	twfuxi: "赴曦",
