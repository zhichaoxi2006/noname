const translates = {
	hm_zhong: "众",
	hm_zhong_info: "锁定技，当你受到伤害后，你摸两张牌。",
	hm_shen_huangfusong: "风云神皇甫嵩",
	hm_shen_huangfusong_prefix: "风云神",
	hm_shen_zhujun: "风云神朱儁",
	hm_shen_zhujun_prefix: "风云神",
	hm_shen_luzhi: "风云神卢植",
	hm_shen_luzhi_prefix: "风云神",
	hm_shen_zhangjiao: "风云神张角",
	hm_shen_zhangjiao_prefix: "风云神",
	hm_shen_zhangbao: "风云神张宝",
	hm_shen_zhangbao_prefix: "风云神",
	...
	hm_cuiji: "摧击",
	hm_cuiji_info: "其他角色的出牌阶段开始时，若你手牌数大于其，你可以将X张手牌当一张雷【杀】对其使用，若你以此法造成了伤害，你摸等量的牌。",
	hm_fudao: "覆道",
	...
	hm_xiangshu: "相鼠",
	hm_xiangshu_info: "其他角色的出牌阶段开始时，若其手牌数不小于体力值，你可以声明一个不大于5的非负整数（你可以弃置一张手牌，令此数字对其他角色不可见），然后此阶段结束时，若X：不大于1，你获得其一张牌；为0，你对其造成1点伤害（X为你声明的数字与其手牌数的差值）。",
	hm_juedian: "决巅",
	...
	hm_shuiqu: "随去",
	hm_shuiqu_info: "锁定技，每名角色的弃牌阶段，你弃置所有手牌。若你以此法弃置了至少一张牌，你可以选择增加一点体力上限或回复1点体力。",
	hm_yure: "余热",
	...
	hm_cheji: "撤击",
	hm_cheji_info: "出牌阶段限一次，你可以重铸任意张牌，然后令一名其他角色重铸等量张手牌，若其重铸的牌含：【杀】，你对其造成一点火焰伤害；【闪】，其对你指定的角色视为使用一张【杀】；【桃】，你与其各摸两张牌。",
	hm_daicui: "怠摧",
	...
	hm_shice: "势策",
	hm_shice_info: "转换技，①：当你受到属性伤害时，若你的技能数不大于伤害来源，你可以防止此伤害并视为使用一张【火攻】；②当你不因此技能使用牌指定唯一目标后，你可以令其弃置装备区任意张牌，然后此牌额外结算X次（X为其装备区的牌数）。",
	hm_podai: "破怠",
