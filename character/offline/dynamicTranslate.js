...
const dynamicTranslates = {
	...
	hm_podai(player) {
		if (player.storage.hm_podai) return '转换技，<span class="bluetext">①：当你受到属性伤害时，若你的技能数不大于伤害来源，你可以防止此伤害并视为使用一张【火攻】</span>；②当你不因此技能使用牌指定唯一目标后，你可以令其弃置装备区任意张牌，然后此牌额外结算X次（X为其装备区的牌数）。'
