const translates = {
	...
	panghong: "庞宏",
	dcpingzhi: "评骘",
	dcpingzhi_info: "转换技，出牌阶段限一次，你可观看一名角色的手牌并选择一张牌，阳：你弃置此牌，其视为对你使用【火攻】，若未造成伤害此技能视为未使用；阴：其使用此牌，若造成伤害则此技能视为未使用。",
	dcgangjian: "刚简",
    ...
    dcaoren: "鏖刃",
    dcaoren_info: "每轮限X次(为“暮锐”中已删除选项数)你使用的基本牌结算完毕后，可将之收回手牌。",
};
