const translates = {
	...
	olshouhun: "兽魂",
	olshouhun_info: "锁定技。①摸牌阶段你额外摸[0]张牌，你的手牌上限+[1]，你的体力上限+[2]。②当你受到伤害时，你令此技能数值最低的一项数值+1。",
	olzishu: "子鼠",
	...
	olmaotu: "卯兔",
	olmaotu_info: "锁定技，一名角色的濒死状态结算完毕后，你不能成为手牌数不小于的其他角色使用牌的目标直到下个回合开始。",
	olchenlong: "辰龙",
	olchenlong_info: "限定技，出牌阶段，你可以失去至多2点体力，对一名其他角色造成等量伤害。若你以此法进入濒死状态，则你减1点体力上限。",
	olsishe: "巳蛇",
