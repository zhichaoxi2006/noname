const translates = {
	...
	zhenbian: "镇边",
	zhenbian_info: "锁定技。①你的手牌上限等于体力上限。②有牌非因使用进入弃牌堆后，你记录这些牌的花色，然后若你因此记录了至少四种花色且你的体力上限小于9，则你清除记录并增加1点体力上限。",
	baoxi: "暴袭",
	baoxi_info: "每轮每项各限一次，当一次性至少有两张基本牌/非基本牌进入弃牌堆时，你可以减1点体力上限，视为对一名角色使用【决斗】/【杀】。",
	fj_peixiu: "裴秀",
	fj_peixiu_ab: "复爵裴秀",
	fjzhitu: "制图",
	fjzhitu_info: "当你使用基本牌或单目标锦囊牌时，你可以令任意名你与其距离相等的角色也成为此牌的目标。",
	dcfujue: "复爵",
	dcfujue_info: "出牌阶段限一次。你可以移动场上一张牌，然后你将牌调整至5张。若你于此流程中获得且失去过牌，本回合你计算与其他角色的距离-1。",
	xj_peixiu: "裴秀",
	xj_peixiu_ab: "修爵裴秀",
	xjzhitu: "制图",
