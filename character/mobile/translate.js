...
const translates = {
	...
	yangfeng: "杨奉",
	mbxuetu: "血途",
	mbxuetu_info: "转换技。①出牌阶段限一次，阴：你可以令一名角色回复1点体力；阳：你可以令一名角色摸两张牌。②游戏开始时，你可令至多两名角色获得牌堆中一张攻击范围为X的武器牌（X为其手牌中的花色数）。",
	mbxuetu_achieve: "血途·成功",
	mbxuetu_achieve_info: "①出牌阶段各限一次。⒈你可以令一名角色回复1点体力；⒉你可以令一名角色摸两张牌。②游戏开始时，你可令至多两名角色获得牌堆中一张攻击范围为X的武器牌（X为其手牌中的花色数）。",
	mbxuetu_fail: "血途·失败",
	mbxuetu_fail_info: "转换技。①出牌阶段限一次，阴：你可以回复1点体力，然后令一名其他角色弃置两张牌；阳：你可以摸一张牌，然后对一名其他角色造成1点伤害。②游戏开始时，你可令至多两名角色获得牌堆中一张攻击范围为X的武器牌（X为其手牌中的花色数）。",
	mbweiming: "威命",
	...
	friendqihui: "启诲",
	friendqihui_info: "锁定技，当你使用牌时。若你没有此牌对应类别的标记，则你获得1个此牌对应类别的“启诲”标记。若你至少拥有3个“启诲”标记，你移去2个“启诲”标记并选择一项：①回复1点体力并重铸一张牌；②摸两张牌且你使用的下一张牌无任何次数限制。",
