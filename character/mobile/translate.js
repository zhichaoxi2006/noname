...
const translates = {
	...
	mbbeini: "悖逆",
	mbbeini_info: "出牌阶段限一次，你可以选择一名体力值不小于你的角色，令你或其摸两张牌，然后未摸牌的角色选择一项：1.视为对摸牌的角色使用一张【杀】；2.弃置摸牌的角色场上的一张牌。",
	mbdingfa: "定法",
	...
	mbshushen: "淑慎",
	mbshushen_info: "每回合每项限一次。当你回复体力时，你可以令一名其他角色摸两张牌；当你获得至少两张牌后，你可以令一名其他角色回复1点体力。",
	pot_taishici: "势太史慈",
	pot_taishici_prefix: "势",
	pothanzhan: "酣战",
	pothanzhan_info: "出牌阶段限一次，你可以选择一名其他角色，你与其将手牌数摸至X张（X为各自体力上限且至多摸三张），然后你视为对其使用一张【决斗】。",
	potzhanlie: "战烈",
	potzhanlie_info: "①一名角色的回合开始时，你记录X（X为你的攻击范围），本回合中的前X张【杀】进入弃牌堆后，你获得等量“烈”标记（你至多拥有6个“烈”标记）。②出牌阶段结束时，你可移除全部”烈”标记（没有标记也可发动），视为使用一张无次数限制的【杀】并选择以下选项中的至多Y项（Y为你本次移除的标记数/2，向下取整）：1.令此【杀】可以额外指定一个目标；2.令此【杀】基础伤害值+1；3.令此【杀】需额外弃置一张牌方可响应；4.此【杀】结算完毕后，你摸两张牌。",
	potzhenfeng: "振锋",
