const translates = {
	...
	ol_yanzhu: "宴诛",
	ol_yanzhu_info: "出牌阶段限一次，你可以令一名其他角色选择一项：1.令你获得其装备区的所有牌，你修改“宴诛”和“兴学”；2.弃置一张牌且下一次受到的伤害+1直到其下个回合开始。",
	ol_yanzhu_rewrite: "宴诛",
	ol_yanzhu_rewrite_info: "出牌阶段限一次，你可以令一名其他角色下一次受到的伤害+1直到其下个回合开始。",
	ol_xinxue: "兴学",
	ol_xinxue_info: "结束阶段，你可令至多X名角色依次摸一张牌，然后其中手牌数大于体力值的角色依次将一张牌置于牌堆顶。（X为你的体力值）",
	ol_xinxue_rewrite: "兴学",
	ol_xinxue_rewrite_info: "结束阶段，你可以令至多X名角色依次摸一张牌，然后其中手牌数大于体力值的角色依次将一张牌置于牌堆顶（X为你的体力上限）。",
	...
	olsbxutu: "徐图",
	olsbxutu_info: "锁定技，游戏开始时，你将牌堆顶3张牌置于你的武将牌上，称为“资”。每个结束阶段，你将本回合弃牌堆的一张牌与一张“资”交换，令一名角色获得3张花色或点数相同的“资”，然后将“资”补至3张。",
	ol_lingtong: "OL界凌统",
	...
	olzhibin: "执柄",
	olzhibin_info: "主公技，锁定技。准备阶段，若其他群势力角色累计使用黑色牌的次数达到：3张，你增加1点体力上限并回复1点体力；6张，你获得〖焚城〗；9张：你获得〖崩坏〗。",
	ol_sb_dengai: "OL谋邓艾",
