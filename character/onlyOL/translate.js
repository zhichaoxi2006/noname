const translates = {
	...
	olyanzhu: "宴诛",
	olyanzhu_info: "出牌阶段限一次，你可以令一名其他角色选择一项：1.令你获得其装备区的所有牌，你修改“宴诛”和“兴学”；2.弃置一张牌且下一次受到的伤害+1直到其下个回合开始。",
	olyanzhu_rewrite: "宴诛",
	olyanzhu_rewrite_info: "出牌阶段限一次，你可以令一名其他角色下一次受到的伤害+1直到其下个回合开始。",
	olxingxue: "兴学",
	olxingxue_info: "结束阶段，你可令至多X名角色依次摸一张牌，然后其中手牌数大于体力值的角色依次将一张牌置于牌堆顶。（X为你的体力值）",
	olxingxue_rewrite: "兴学",
	olxingxue_rewrite_info: "结束阶段，你可以令至多X名角色依次摸一张牌，然后其中手牌数大于体力值的角色依次将一张牌置于牌堆顶（X为你的体力上限）。",
