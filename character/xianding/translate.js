const translates = {
	...
	v_sunquan_prefix: "威",
	dcwoheng: "斡衡",
	dcwoheng_info: "出牌阶段或当你受到伤害后，你可令一名其他角色摸或弃置X张牌，选择其他角色结算后其手牌数与你不同或X不小于5，你摸两张牌且此技能失效至本回合结束（X为此技能本轮发动的次数）。",
	dcyuhui: "御麾",
	dcyuhui_info: "结束阶段，选择任意名其他吴势力角色，其出牌阶段开始时可选择交给你一张红色基本牌并发动一次X为1的“斡衡”。",
	sunba: "孙霸",
	dcjiedang: "结党",
	dcjiedang_info: "①回合开始时，你可以：令所有角色将任意张牌置于你的武将牌上，因此失去牌的角色摸一张牌；②出牌阶段开始时，或结束阶段，或当你进入濒死状态时，你移去你武将牌上的一种类别的所有牌并摸等量张牌",
	dcjidi: "觊嫡",
    ...
    dcbaguan: "霸关",
    dcbaguan_info: "连招技（指定自己为目标的牌+武器牌)（无目标牌不计入在内），你可将至多X张手牌当作基础伤害为对应实体牌数且不计入次数，无次数限制的【杀】使用(X为你装备区武器牌字数之和)。",
};
