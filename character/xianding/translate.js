const translates = {
	...
	lvju: "吕据",
	dczhengyue: "征越",
	dczhengyue_info: "回合开始时，若你武将牌上没有牌，你可至多将牌堆顶五张牌以任意顺序放置武将牌上；你使用牌结算后若与武将牌上首张牌点数或花色或牌名相同时，弃置武将牌上首张牌并摸两张牌，若皆不同，将此牌放置武将牌上并调整任意顺序（武将牌上至多五张牌），每以此法放置两张牌，当前回合不可再使用手牌。",
	v_sunquan: "威孙权",
	v_sunquan_prefix: "威",
	dcwoheng: "斡衡",
