const translates = {
	...
	v_sunquan_prefix: "威",
	dcwoheng: "斡衡",
	dcwoheng_info: "出牌阶段或当你受到伤害后，你可令一名其他角色摸X张牌或弃置X张牌，然后若其手牌数与你不同或X不小于5，你摸两张牌且此技能失效至本回合结束（X为此技能本轮发动的次数）。",
	dcyuhui: "御麾",
	dcyuhui_info: "结束阶段，你可以选择任意名其他吴势力角色，其下个出牌阶段开始时，可以交给你一张红色基本牌并发动一次X为1的〖斡衡〗。",
	sunba: "孙霸",
	dcjiedang: "结党",
