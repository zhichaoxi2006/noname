const translates = {
	...
	lvju: "吕据",
	dczhengyue: "征越",
	dczhengyue_info: "回合开始时，若你武将牌上没有牌，你可至多将牌堆顶五张牌以任意顺序放置武将牌上；你使用牌结算后若与武将牌上首张牌点数或花色或牌名相同时，弃置武将牌上首张牌并摸2张牌，若皆不同，将此牌放置武将牌上并调整任意顺序（武将牌上至多5张牌），每以此法放置2张牌，当前回合不可再使用手牌。",
	v_sunquan: "威孙权",
	v_sunquan_prefix: "威",
	dcwoheng: "斡衡",
	dcwoheng_info: "出牌阶段或当你受到伤害后，你可令一名角色摸或弃置X张牌，选择其他角色结算后其手牌数与你不同或选择自己时， 此技能失效至本回合结束(X为此技能本轮发动的次数)。",
	dcjizheng: "集征",
	dcjizheng_info: "威主技，其他吴势力角色出牌阶段限一次，其可交给你一张牌，则其本回合使用牌无距离限制。其他角色出牌阶段限一次，其可交给你一张牌，则其本回合使用的下张牌无距离限制。",
};
