const translates = {
	...
	ol_niufu_prefix: "OL",
	olshisuan: "筮算",
	olshisuan_info: "锁定技，当你受到伤害后，你弃置一张牌，然后伤害来源选择一项：①失去1点体力；②交给你一张装备区的牌；③将武将牌翻面。",
	olzonglve: "纵掠",
	...
	spolxixiang: "西向",
	spolxixiang_info: "出牌阶段各限一次，你可以将至少X张牌当作无任何次数限制的【杀】或【决斗】对一名角色使用（X为本回合所有角色本回合使用基本牌的次数+1）。此牌结算后，若其体力值：大于你的手牌数，你摸一张牌；大于你的体力值，你回复1点体力，然后获得其一张牌。",
	spolaige: "哀歌",
	spolaige_info: "觉醒技。每回合第二次濒死结算结束后，你失去〖西向〗并获得〖逐北〗，然后将手牌摸至X张，将体力回复至X点（X为该濒死角色的体力上限）。",
	spolzhubei: "逐北",
	spolzhubei_info: "出牌阶段各限一次，你可以令一名其他角色将至少X张牌当作无任何次数限制的【杀】或【决斗】对你使用（X为本回合所有角色本回合使用基本牌的次数+1）。当你以此法受到伤害后，你可以获得这些牌；此牌结算后，若你未以此法受到伤害，你回复1点体力，然后可以与其交换手牌。",
	ol_nanhualaoxian: "OL南华老仙",
	ol_nanhualaoxian_prefix: "OL",
	olhedao: "合道",
	olhedao_info: "锁定技，游戏开始时/当你首次进入濒死状态时，你至多可拥有的“天书”上限+2/+1。",
	olhedao_faq: "关于天书",
	olhedao_faq_info: "<br>书写“天书”时，系统先从30个“天书”时机中随机筛选出三个，角色选择时机后，系统再从30个“天书”效果中随机筛选出三个可以和选择的时机匹配的效果，然后角色获得技能为你选择的“天书”时机+“天书”效果的〖天书〗，此技能被发动前对其余玩家不可见，发动两次时失去此〖天书〗。",
	olqingshu: "青书",
	...
	olsiqi: "思泣",
	olsiqi_info: "你的红色牌进入弃牌堆时，将之置于牌堆底。当你受到伤害后，你可以亮出牌堆底至多五张连续的红色牌，使用其中【桃】、【酒】、【无中生有】与装备牌（可指定其他角色为目标），然后你摸剩余不可使用的牌数张牌。",
	olqiaozhi: "巧织",
	olqiaozhi_info: "出牌阶段，你可以弃置一张牌并亮出牌堆顶的两张牌，然后获得其中一张，此技能失效直到你失去以此法获得的牌。",
	ol_guozhao: "OL郭照",
	ol_guozhao_prefix: "OL",
	oljiaoyu: "椒遇",
	oljiaoyu_info: "锁定技，每轮开始时，你进行X次判定(X为你装备区内牌数且至少为1),然后声明一种颜色并获得此颜色的判定牌。你的下回合结束时，你执行一个出牌阶段(此阶段你不能使用与声明颜色不同的牌)。",
	olneixun: "内训",
	olneixun_info: "锁定技，其他角色于回合内使用第一张非装备牌后，若此牌与你以“椒遇”声明的颜色相同/不同，你交给/获得其一张牌，然后失去牌的角色摸一张牌。你以此法获得的牌不计入手牌上限直到你回合结束。",
	ol_taoqian: "OL陶谦",
