const translates = {
	...
	ol_jiaoyu: "椒遇",
	ol_jiaoyu_info: "锁定技，每轮开始时，你进行X次判定(X为你装备区内牌数且至少为1),然后声明一种颜色并获得此颜色的判定牌。你的下回合结束时，你执行一个出牌阶段(此阶段你不能使用与声明颜色不同的牌)。",
	ol_neixun: "内训",
	ol_neixun_info: "锁定技，其他角色于回合内使用第一张非装备牌后，若此牌与你以“椒遇”声明的颜色相同/不同，你交给/获得其一张牌，然后失去牌的角色摸一张牌。你以此法获得的牌不计入手牌上限直到你回合结束。",
	ol_taoqian: "OL陶谦",
