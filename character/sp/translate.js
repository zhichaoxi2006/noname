const translates = {
	...
	spolxixiang: "西向",
	spolxixiang_info: "出牌阶段限一次。你可以将任意张牌当【杀】或【决斗】对一名角色使用。此牌结算后，若其体力值：大于你的手牌数，你摸一张牌；大于你的体力值，你获得其一张牌。",
	spolaige: "哀歌",
	spolaige_info: "觉醒技。每回合第二次濒死结算结束后，你失去〖西向〗并获得〖逐北〗，然后将手牌摸至X张，将体力回复至X点（X为该濒死角色的体力上限）。",
	spolzhubei: "逐北",
	spolzhubei_info: "出牌阶段限一次。你可以令一名其他角色将任意张牌当【杀】或【决斗】对你使用。当你以此法受到伤害后，你可以获得这些牌；此牌结算后，若你未以此法受到伤害，你可以与其交换手牌。",
